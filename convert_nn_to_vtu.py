#!/usr/bin/env python3
"""
Convert Neural Network Predictions to ParaView-compatible VTU format (modern VTK)

This script converts the .npz neural network predictions to VTU files
...
def main():
    ...
    """
    print("Neural Network Predictions to ParaView VTU Converter")
    print("=" * 60)
    
    # Input and output directories
    input_dir = "validation/neural_network_predictions"
    output_dir = "validation/paraview_vtu"
    ...
    print(f"   4. Each .pvd file contains the full time series for one validation case")
